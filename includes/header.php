...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="<?php echo url; ?>/">N.S &nbsp;&nbsp;Coffee<small>Delicious Taste</small></a>
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a href="<?php echo url; ?>/menu" class="nav-link">Menu</a>
          </li>
          <li class="nav-item">
          ...
          ?>
            ...
            <li class="nav-item cart">
              <a href="<?php echo url; ?>/products/cart" class="nav-link"><span class="icon icon-shopping_cart"></span></a>
            </li>
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="<?php echo url; ?>/users/bookings">My Bookings</a></li>
                <li><a class="dropdown-item" href="<?php echo url; ?>/users/orders">My Orders</a></li>
                <li>
          ...
          <?php } else { ?>
            ...
            <li class="nav-item">
              <a href="<?php echo url; ?>/auth/register" class="nav-link">register</a>
            </li>
          <?php } ?>
        </ul>
      </div>
